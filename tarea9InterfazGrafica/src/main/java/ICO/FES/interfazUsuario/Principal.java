package ICO.FES.interfazUsuario;

import ICO.FES.interfazUsuario.eventos.eventosMouse;
...
public class Principal extends Frame {
    ...
    public Principal(String title) throws HeadlessException {
        ...
        //btnBoton1.addMouseListener(new eventosMouse());
        btnBoton1.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                System.out.println(txtNombre.getText());
                JOptionPane.showMessageDialog(null,"Hola "+ txtNombre.getText());//swing
            }
        });
        this.add(btnBoton1);
