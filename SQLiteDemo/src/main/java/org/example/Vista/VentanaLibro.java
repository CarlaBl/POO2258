...
public class VentanaLibro extends JFrame {
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(136, 232, 232));
        lblId = new JLabel("Id: ");
        ...
        panel2.setBackground(new Color(136, 232, 115));
        ...
        panel3.setBackground(new Color(250, 243, 114));

        //panel4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(241, 101, 69));
